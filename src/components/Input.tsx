...
//             console.log("Response from FastAPI:", data); // ✅ Debugging log
    
//             if (data.status === "success") {
//                 setMessage("✅ Successful: Medical terms detected!");
//             } else {
//                 setMessage("❌ Invalid file: No medical terms found.");
//             }
//         } catch (error) {
...
//                             <img src={filepreview} alt={selectedFile.name}  className="w-full h-full object-contain border rounded-lg shadow-md"/>
//                         ):(
//                             <iframe src={filepreview} title='pdf review'  className="w-full h-full object-contain border rounded-lg shadow-md"></iframe>
//                         )}
//                     </div>
//                 )}
//                 {message && (<div>
